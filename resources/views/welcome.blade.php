...
<body class="text-white">
    ...
    <section id="parallax" class="min-h-screen flex flex-col items-center justify-center text-center px-6 relative">
        ...
        <!-- CTA Button -->
        <div data-aos="fade-up" data-aos-delay="400" class="flex justify-center mt-6">
            <a href="/login"
    ...
    <section class="py-16 px-8 bg-white text-gray-800">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div class="tilt p-6 rounded-2xl shadow hover:shadow-xl transition">
                ...
                <p>Experience instant system feedback with live data synchronization.</p>
            </div>

            <div class="tilt p-6 rounded-2xl shadow hover:shadow-xl transition">
                <h3 class="font-bold text-lg mb-2">📱 Seamless Remote Access</h3>
                <p>Control your AC system anytime, anywhere with ease.</p>
            </div>

            <div class="tilt p-6 rounded-2xl shadow hover:shadow-xl transition">
                <h3 class="font-bold text-lg mb-2">🔄 Intelligent Synchronization</h3>
                <p>Keeps system data consistent even after device restart.</p>
            </div>
    ...
    <!-- ===== SCRIPTS — urutan penting: AOS → Particles → Tilt → init ===== -->

    <!-- AOS -->
    <script src="https://unpkg.com/aos@2.3.4/dist/aos.js"></script>

    <!-- Particles (hanya desktop) -->
