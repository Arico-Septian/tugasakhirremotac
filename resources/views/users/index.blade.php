...
<head>
    ...
    <style>
        ...
        .sidebar.close .menu-text { display: none; }
        .sidebar.close h2 span { display: none; }
        .sidebar.close ul li a { justify-content: center; }

        .main-content { margin-left: 260px; transition: all .3s ease; }
        .sidebar.close+.main-content { margin-left: 100px; }
...
<div id="sidebar" class="sidebar fixed top-0 left-0 w-64 bg-white shadow-lg h-full p-6 border-r z-50">
    ...
    <ul class="space-y-3">
        ...
        <li>
            <a href="/users" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-blue-50 text-blue-600 font-semibold">
        ...
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="p-3">
                        @if ($user->is_online)
                            <span class="bg-green-100 text-green-600 px-2 py-1 rounded text-xs">Online</span>
                        @else
...
<div id="modal" class="hidden fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center">
    ...
    <div class="bg-white p-8 rounded-xl w-96">
        ...
        <form method="POST" action="/users">
            ...
            <input type="password" name="password" placeholder="Password" class="border p-3 w-full mb-3 rounded" required>
