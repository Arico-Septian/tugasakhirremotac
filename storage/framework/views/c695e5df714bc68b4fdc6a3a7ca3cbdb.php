                ...
                <div class="app-content-inner space-y-4">
                                ...
                                <div class="field">
                                    ...
                                    <select class="input" name="room">
                                        ...
                                        <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($r); ?>" <?php echo e(request('room') === $r ? 'selected' : ''); ?>>
                                                <?php echo e($r); ?>
                                ...
                                <div class="field">
                                    ...
                                    <select class="input" name="activity">
                                        ...
                                        <?php $__currentLoopData = $activityOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($val); ?>" <?php echo e(request('activity') === $val ? 'selected' : ''); ?>>
                                                <?php echo e($label); ?>
                        ...
                        <div class="stat-card acc-cyan">
                            ...
                            <div class="flex items-start justify-between gap-3">
                                <div>
                                    ...
                                    <p class="stat-meta"><?php echo e(count($activeFilters) ? 'Hasil filter' : 'All-time event count'); ?></p>
                                </div>
                        ...
                        <div class="stat-card acc-mint">
                            ...
                            <div class="flex items-start justify-between gap-3">
                                <div>
                                    ...
                                    <p class="stat-value"><?php echo e($logs->currentPage()); ?><span class="text-mono" style="font-size:16px;color:var(--ink-3);"> / <?php echo e($logs->lastPage()); ?></span></p>
                        ...
                        <div class="stat-card acc-lavender">
                            ...
                            <div class="flex items-start justify-between gap-3">
                                <div>
                                    ...
                                    <p class="stat-value"><?php echo e($logs->firstItem() ?? 0); ?><span class="text-mono" style="font-size:16px;color:var(--ink-3);">–<?php echo e($logs->lastItem() ?? 0); ?></span></p>
                    ...
                    <div class="tbl-wrap">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div style="padding:14px 16px;border-bottom:1px solid var(--line-soft);">
                                    <div class="flex items-center justify-between gap-2 mb-1.5">
                                        <span class="text-sm font-semibold" style="color:var(--ink-0);"><?php echo e($log->user->name ?? '-'); ?></span>
                                    ...
                                    <div class="text-xs space-y-0.5" style="color:var(--ink-3);">
                                        <?php if($log->room): ?><p><i class="fa-solid fa-server mr-1.5 text-[10px]"></i><?php echo e($log->room); ?></p><?php endif; ?>
                                        <?php if($log->ac): ?><p><i class="fa-solid fa-snowflake mr-1.5 text-[10px]"></i><?php echo e($log->ac); ?></p><?php endif; ?>
                                    </div>
                                    <p class="text-mono text-xs mt-1.5" style="color:var(--ink-4);"><?php echo e($log->created_at->format('d M Y H:i')); ?></p>
                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex items-center gap-2.5">
                                                    ...
                                                    <span class="font-medium" style="color:var(--ink-0);"><?php echo e($log->user->name ?? '—'); ?></span>
                                                </div>
                                            </td>
                                            <td><?php echo e($log->room ?? '—'); ?></td>
                                            <td class="max-w-[240px] truncate" title="<?php echo e($log->ac); ?>"><?php echo e($log->ac ?? '—'); ?></td>
                                            <td>
                                                <?php [$label, $class] = activityBadge($log->activity); ?>
                                                <span class="act-badge <?php echo e($class); ?>"><?php echo e($label); ?></span>
                                            </td>
                                            <td class="num whitespace-nowrap"><?php echo e($log->created_at->format('d M Y H:i')); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr><td colspan="5">
                                            <div class="empty-state">
                        ...
                        <div class="tbl-footer">
                            <p>
                                Showing <span class="text-mono" style="color:var(--ink-1);"><?php echo e($logs->firstItem() ?? 0); ?></span>–<span class="text-mono" style="color:var(--ink-1);"><?php echo e($logs->lastItem() ?? 0); ?></span>
                                of <span class="text-mono" style="color:var(--ink-1);"><?php echo e($logs->total()); ?></span>
                            </p>
                            <div class="pager">
