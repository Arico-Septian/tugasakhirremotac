                                ...
                                <div style="padding:12px;border-bottom:1px solid rgba(14, 165, 233, 0.08);display:flex;justify-content:space-between;align-items:center;">
                                    <div>
                                        ...
                                        <p style="font-size:12px;color:var(--ink-3);margin:4px 0 0 0;">
                                            <span style="display:inline-block;margin-right:8px;"><i class="fa-solid fa-door-open" style="color:var(--ink-4);margin-right:4px;"></i><?php echo e($activity->room ?? '-'); ?></span>
                                            <?php if($activity->ac): ?>
                                            <span style="display:inline-block;"><i class="fa-solid fa-snowflake" style="color:var(--cyan);margin-right:4px;"></i>AC <?php echo e($activity->ac); ?></span>
                                            <?php endif; ?>
                                        </p>
                                    </div>
