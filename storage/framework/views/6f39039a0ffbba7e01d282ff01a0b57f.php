                                    ...
                                    <div class="floor-grid grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 gap-3 mb-6">
                                        <?php $__currentLoopData = $floorRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="room-card"
                                                ...
                                                <div class="temp-chip <?php echo e($tempClass); ?>" style="justify-content:space-between;width:100%;">
                                                ...
                                                <div class="ac-mini">
                                                    <div>
                                                        <p class="num" style="color:var(--mint);"><?php echo e($activeCount); ?></p>
                                                        <p class="lbl">Active</p>
                                                    </div>
                                                    <div>
                                                        <p class="num" style="color:var(--ink-2);"><?php echo e($inactiveCount); ?></p>
                                                        <p class="lbl">Idle</p>
                                                    </div>
                                                </div>

                                                <div class="flex gap-1.5 mt-auto pt-1">
                                                    <a href="/rooms/<?php echo e($room->id); ?>/status" class="btn btn-primary btn-sm flex-1">
                                                        Detail
                                                    </a>
                                                    <button type="button"
