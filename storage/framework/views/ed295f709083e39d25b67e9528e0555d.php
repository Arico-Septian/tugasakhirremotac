                            ...
                            <div class="stat-card acc-coral">
                                ...
                                <div class="flex items-start justify-between gap-3">
                                    <div>
                                        ...
                                        <p class="stat-num-lg" id="offlineUsersCount"><?php echo e($offlineUsers); ?></p>
                                        <p class="stat-sub"><span id="offlineUsersPct"><?php echo e($offlinePercentage); ?></span>% tidak aktif</p>
                                    </div>
                        ...
                        <div class="tbl-wrap">
                                        ...
                                        <div class="user-card-header">
                                            <div class="user-card-info">
                                                ...
                                                <div class="user-card-name">
                                                    <span class="user-card-name-text"><?php echo e(ucfirst($user->name)); ?></span>
                            ...
                            <table id="user-list" class="user-table">
                                ...
                                <tbody>
                                    ...
                                    <?php endif; ?>
                                                    <div class="user-info">
                                                        <p class="user-name"><?php echo e(ucfirst($user->name)); ?></p>
